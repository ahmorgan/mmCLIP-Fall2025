...
epoch_name = "src/babel_0505_5set/babel-human3d-kl-mbvitv3nosw-3group-seed2024/checkpoint_cliplarge/30000_checkpoint.pt"
use_muon = False
use_category_alignment = False # experimental pseudo-category-alignment for finetuning
use_hmtext_cross_attention = False
lam = 1.0

# 15000 + no muon in ft + 500 seems to work good?
...
# 3 test sets for zero-shot pretrained model + fine-tuning (these runs averaged is the zeroshot mmCLIP result)
    ...
    {"exp_setting": f"mbvitv3-ft-seen50klnosw-seed2024-26800-TESTSET{i}",
     "num_ll": 1, "dim_ll": 64,
     ...
     "train_classes_real": split[1],
     "train_classes_num": False,
     "test_classes_real": split[0],
     "batch_size": 16,
     "loss_type": "kl",
     "train_ratio": 1,
     "test_ratio": 1,
     ...
     "use_muon": use_muon,
     "use_category_alignment": use_category_alignment,
